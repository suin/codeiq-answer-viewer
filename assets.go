...
var assets = map[string]string{
    ...
    linkDetail = ->
        $(document).on "click", "a.detail", ->
            ...
            return false`,
	"script.js": `// Generated by CoffeeScript 1.6.3
(function() {
  jQuery(function() {
...
")
	...
	<div class="footer" style="margin-bottom:20px;">
		<div>CodeIQ Answer Viewer | <a href="https://github.com/suin/codeiq-answer-viewer" target="_blank">Fork on GitHub</a></div>
	</div>
</div>
